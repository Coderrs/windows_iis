# Class: windows_iis
#
# This module manages iis and depends on forge's puppet-iis module
#
class windows_iis {
  $site_folders_to_ensure = ["C:\\inetpub\\", "C:\\inetpub\\wwwroot", "C:\\inetpub\\wwwroot\\mysite"]
  ...
  # Below code for sake of website hosting and showing index.html at http://localhost/mysite
